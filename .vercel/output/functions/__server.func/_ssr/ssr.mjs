import "../_runtime.mjs";
import { a as RouterProvider, d as require_react, f as require_jsx_runtime, n as defineHandlerCallback, t as renderRouterToStream } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DShjuS4i.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BRuXdvz2.mjs"),
		import("./start-BRg9gTVS.mjs"),
		import("./empty-plugin-adapters-CHUbojQe.mjs")
	]);
	return {
		routerEntry,
		startEntry,
